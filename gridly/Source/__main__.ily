...
% Variable: gridDisplay
% text about gridDisplay
gridDisplay =
...
% Variable: gridPutMusic
% text about gridPutMusic
gridPutMusic =
#(define-void-function
...
% Variable: gridSetSegmentTemplate
% text about gridSetSegmentTemplate
...
% Variable: gridGetRange
% text about gridGetRange
gridGetRange =
#(define-music-function (part start-end)(string? segment-selector?)
   (gridSetRange start-end)
   (gridGetMusic part))

% Variable: gridSetRange
% text about gridSetRange
gridSetRange =
#(define-void-function
...
% Variable: gridGetMusic
% text about gridGetMusic
gridGetMusic =
...
% Variable: gridGetLyrics
% text about gridGetLyrics
gridGetLyrics =
#(define-music-function
   (parser location part) (string?)
   (let* ((cells (get-cell-range part #{ \getOption gridly.segment-range #}))
